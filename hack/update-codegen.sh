...
ROOT_PKG=github.com/dafu-wu/common
...
${CODEGEN_PKG}/generate-groups.sh "deepcopy" \
 github.com/dafu-wu/common/pkg/client github.com/dafu-wu/common/pkg/apis \
 common:v1 \
 --output-base "${TEMP_DIR}" \
 --go-header-file hack/boilerplate/boilerplate.go.txt

${CODEGEN_PKG}/generate-groups.sh "all" \
 github.com/dafu-wu/common/test_job/client github.com/dafu-wu/common/test_job/apis \
 test_job:v1 \
 --output-base "${TEMP_DIR}" \
 --go-header-file hack/boilerplate/boilerplate.go.txt
...
${GOPATH}/bin/defaulter-gen --input-dirs github.com/dafu-wu/common/pkg/apis/common/v1 \
-O zz_generated.defaults \
--output-package github.com/dafu-wu/common/pkg/apis/common/v1 \
--go-header-file hack/boilerplate/boilerplate.go.txt "$@" \
--output-base "${TEMP_DIR}" 

echo "Generating defaulters for test_job/v1"
${GOPATH}/bin/defaulter-gen --input-dirs github.com/dafu-wu/common/test_job/apis/test_job/v1 \
-O zz_generated.defaults \
--output-package github.com/dafu-wu/common/test_job/apis/test_job/v1 \
--go-header-file hack/boilerplate/boilerplate.go.txt "$@" \
--output-base "${TEMP_DIR}" 
...
${GOPATH}/bin/openapi-gen --input-dirs github.com/dafu-wu/common/pkg/apis/common/v1 \
--output-package github.com/dafu-wu/common/pkg/apis/common/v1 \
--go-header-file hack/boilerplate/boilerplate.go.txt "$@" \
--output-base "${TEMP_DIR}" 

echo "Generating OpenAPI specification for test_job/v1"
${GOPATH}/bin/openapi-gen --input-dirs github.com/dafu-wu/common/test_job/apis/test_job/v1 \
--output-package github.com/dafu-wu/common/test_job/apis/test_job/v1 \
--go-header-file hack/boilerplate/boilerplate.go.txt "$@" \
--output-base "${TEMP_DIR}" 
